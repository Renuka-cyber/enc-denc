    ...
    <Card className="w-full max-w-lg mx-auto shadow-xl">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="image-file">Image Input</Label>
          <Input id="image-file" type="file" accept="image/png, image/jpeg" onChange={handleImageChange} />
        ...
        {mode === 'embed' && (
          <div className="space-y-2">
            <Label htmlFor="text-to-hide">Text to Hide</Label>
            <Textarea
              id="text-to-hide"
